...
# MEDIA_ROOT = os.path.join(BASE_DIR, 'path/to/fake/documents')
# MEDIA_URL = '/media/'
...
SECRET_KEY = 'django-insecure-2qt392&s$ixjs1fwu!$rusfsy@kbi+4)s=y6nad!zb-(-u&x7q'
...
# If your static files are in a specific directory, add it here:
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
